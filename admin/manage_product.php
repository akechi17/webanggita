		...
		<div class="card">
			<div class="card-body">
				<form action="" id="manage-product">
					...
					<h4><b><?= !isset($id) ? "New Product" : "Manage Product" ?></b></h4>
					<hr>
					...
					<div class="form-group row">
						<div class="col-md-10">
							...
							<textarea name="description" id="description" class="form-control" cols="30" rows="5" required><?= isset($description) ? html_entity_decode($description) : '' ?></textarea>
						</div>
					</div>

					<div class="form-group row">
						<div class="col-md-4">
							<label for="" class="control-label">Harga Normal</label>
							<input type="number" class="form-control text-right" name="harga_normal" value="<?= isset($harga_normal) ? $harga_normal : 0 ?>">
						</div>
						<div class="col-md-4">
							<label for="" class="control-label">Starting Bidding Amount</label>
							<input type="number" class="form-control text-right" name="harga_awal" value="<?= isset($harga_awal) ? $harga_awal : 0 ?>">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-4">
							<label for="" class="control-label">Bidding Waktu Penutupan</label>
							<input type="text" class="form-control datetimepicker" name="bid_end_datetime" value="<?= isset($bid_end_datetime) && strtotime($bid_end_datetime) > 0 ? date("Y-m-d H:i", strtotime($bid_end_datetime)) : '' ?>">
						</div>
					</div>
					<div class=" row form-group">
						...
						<div class="col-md-5">
							<img src="<?= isset($img_fname) ? 'assets/uploads/' . $img_fname : '' ?>" alt="" id="img_path-field">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
